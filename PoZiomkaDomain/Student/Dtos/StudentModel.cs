...
public record StudentModel(int Id, string Email, string FirstName, string LastName, string PasswordHash, bool IsConfirmed, string? PhoneNumber, string? IndexNumber,
