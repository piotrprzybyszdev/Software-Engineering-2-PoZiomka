...
public record StudentModel(int Id, string Email, string? FirstName, string? LastName, string? PasswordHash,
    bool IsConfirmed, string? PhoneNumber, string? IndexNumber, int? ReservationId,
    bool? HasAcceptedReservation, int? RoomId, bool IsPhoneNumberHidden, bool IsIndexNumberHidden)
{
